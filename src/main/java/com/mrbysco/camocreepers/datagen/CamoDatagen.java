...
public class CamoDatagen {
	...
	public static void gatherData(GatherDataEvent event) {
		...
		generator.addProvider(event.includeServer(), new CreeperLoot(packOutput, lookupProvider));
	}
	...
	private static class CreeperLoot extends LootTableProvider {
		public CreeperLoot(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> completableFuture) {
